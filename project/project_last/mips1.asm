...
print_file:
    ...
    li   $a1, 0x41           # Flags: O_WRONLY | O_CREAT | O_APPEND (append mode)
    li   $a2, 0              # Permissions: rw-rw-rw- (read/write for owner/group/other)
    ...
    l.s  $f12, 0($t7)        # Load the float value into $f12

    li   $v0, 15             # Syscall for writing to file (float)
    move $a0, $t0            # File descriptor
    li   $a2, 4              # Length of the float to be printed
    syscall
...
complete_print2:
    ...
    li   $a2, 18             # Length of the string "System complete."
    syscall
